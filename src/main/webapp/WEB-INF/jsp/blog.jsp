	...
	<div id="top_Nav">
		...
		<div id="top_Login">
			...
			<div id="top_SelfInfo">
				...
				<img alt="" src="img/退出.png" style="position:absolute;left:104px;top:100px">
			</div>
		</div>
	</div>
	<div id="mid_Content">
		...
		<div id="blogarea">
			<div style="border:1px solid black;width:875px;height:180px;position:absolute;top:50px;left:50px;" onclick="window.location = 'userBlogarea.action'"></div>
		</div>
