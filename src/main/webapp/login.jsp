...
<body>
	...
	<div id="login">
		...
		<form action="userLogin" target="" method="post">
			<p><input type="text" class="text" maxlength="26" name="username_phonenumber_email" placeholder="输入用户名、手机号或邮箱" ></p>
			<p><input type="password" class="psw" maxlength="16" name="password" placeholder="请输入登录密码"/></p>
	...
	<div id="title">
		...
		<form onsubmit="return checkSub()">
			...
			<p><input type="password" required="required" class="psw" maxlength="16" name="repassword" placeholder="确认密码"/ onblur="checkPassword()"></p>
			<p><input type="password" required="required" class="psw" maxlength="16" name="phonenumber" placeholder="手机"/ onblur="checkTel()"></p>
			<p><input type="password" required="required" class="psw" maxlength="16" name="email" placeholder="邮箱"/ onblur="checkEmail()"></p>
			<div onclick="sent()" style="display:inline-block;">
			<input type="button" name="sent"  value="发送邮件">
			</div>
			<p><input type="password" required="required" class="psw" maxlength="16" name="emailCode" placeholder="邮箱注册码"/ onblur="check()"></p>
